...
You can create snapshots of virtual machines (VMs) by using the {product-title} web console or the command line. You can also clone an existing snapshot.
...
[id="cloning-snapshots_virt-backup-restore-snapshots"]
== Cloning snapshots

You can clone an existing virtualmachine snapshot.
