...
To prevent the inadvertent deletion of a virtual machine (VM), you can enable virtual machine delete protection by using the {product-title} web console. Should you change your mind, you can easily disable delete protection for a VM.
