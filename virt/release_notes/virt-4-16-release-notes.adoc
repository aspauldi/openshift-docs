...
+
The `vm-dump-metrics` tool is not supported on Red Hat Enterprise Linux 9. xref:../../virt/monitoring/virt-viewing-downward-metrics-cli.adoc#virt-viewing-downward-metrics-cli[Use the command line] to view downward metrics.
