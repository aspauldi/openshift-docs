...
The `vm-dump-metrics` tool is not supported on Red Hat Enterprise Linux 9. You can instead xref:../../virt/monitoring/virt-viewing-downward-metrics-cli.adoc#virt-viewing-downward-metrics-cli[use the command line] to view downward metrics.
