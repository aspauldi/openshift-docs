...
If the VM is delete protected, the *Delete* action is disabled in the VM's *Actions* menu. To delete the VM you must first disable the VM's delete protection setting.
